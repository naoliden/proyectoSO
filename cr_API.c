...
// TODO: Revisar los dos primeros writes: el para escribir el valid bit, y el para escribir el contador de harllinks
int cr_rm(char* path){
	...
	// DESCOMENTAR !! ES PARA NO DISMINUIR EL CONTADOR DE HARDLINKS TODO EL RATO
	// hardlinks_counter--;
